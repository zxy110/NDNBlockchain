...
public class Configure {
    ...
    public static final int INITBLOCKSIZE = 285;             //区块大小
    public static final int TARGET_BITS = 32;                //难度值
    ...
    public static String Consensus = "Pow";
    ...
    public static ByteBuffer getPublicKey(){ return DEFAULT_RSA_PUBLIC_KEY_DER; }
