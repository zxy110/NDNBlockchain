...
public class Configure {
	public static final int INITBLOCKSIZE = 52;
	public static final int MAXBLOCKSIZE = 64; //最大的区块大小
	public static final int OFFSETINIT = 0;
	public static final int SHA256SIZE = 32;
	...
	public static ByteBuffer getPublicKey(){
		return DEFAULT_RSA_PUBLIC_KEY_DER;
	}
	
	public static ByteBuffer getPrivateKey(){
		return DEFAULT_RSA_PRIVATE_KEY_DER;
	}
	
	private static final ByteBuffer DEFAULT_RSA_PUBLIC_KEY_DER = Utils.arrayToBuffer(new int[] {
	...
	private static final ByteBuffer DEFAULT_RSA_PRIVATE_KEY_DER = Utils.arrayToBuffer(new int[] {
